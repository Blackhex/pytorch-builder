if "%VS_YEAR%" == "2017" powershell windows/internal/vs2017_install.ps1
if "%VS_YEAR%" == "2019" powershell windows/internal/vs2019_install.ps1
if "%VS_YEAR%" == "2022" powershell windows/internal/vs2022_install.ps1
