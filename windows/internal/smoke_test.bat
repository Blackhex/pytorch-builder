...
if "%VS_YEAR%" == "2017" powershell internal\vs2017_install.ps1
if "%VS_YEAR%" == "2019" powershell internal\vs2019_install.ps1
if "%VS_YEAR%" == "2022" powershell internal\vs2022_install.ps1
...
:vswhere
IF "%VS15VCVARSALL%"=="" (
    echo Visual Studio %VS_YEAR% C++ BuildTools is required to compile PyTorch test on Windows
    exit /b 1
)
