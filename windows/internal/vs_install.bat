...
set VS_DOWNLOAD_LINK=https://aka.ms/vs/14/release/vs_buildtools.exe
IF "%VS_LATEST%" == "1" (
   ...
   set VS_INSTALL_ARGS=--nocache --quiet --wait --add Microsoft.VisualStudio.Workload.VCTools ^
                                                --add Microsoft.VisualStudio.Component.VC.Tools.14.33 ^
   ...
   set VSDEVCMD_ARGS=-vcvars_ver=14.33
)
