...
IF "%CUDA_PATH_V117%"=="" (
    IF EXIST "C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.7\bin\nvcc.exe" (
        set "CUDA_PATH_V117=C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.7"
    ) ELSE (
        echo CUDA 11.7 not found, failing
        exit /b 1
    )
)
...
set "CUDA_PATH=%CUDA_PATH_V117%"
set "PATH=%CUDA_PATH_V117%\bin;%PATH%"
